...
const columns = [
  {
    title: "Featured",
    links: ["Best Sellers", "New Arrivals", "Hotel Collection", "Back Pain Relief"],
  },
  {
    title: "Mattresses",
    links: ["All Mattresses", "Memory Foam", "Latex", "Hybrid", "Orthopedic", "Custom Mattress"],
  },
  {
    title: "Shop by Need",
    links: ["Back Pain Support", "Side Sleepers", "Back Sleepers & Hot Sleepers", "Motion Isolation"],
  },
  {
    title: "Shop by Size'",
    links: ["Single", "Double", "Queen", "King", "California King"],
  },
] as const;
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 items-start gap-8 md:grid-cols-12">
          <div className="flex items-start md:col-span-3">
            <Image src="/logo.svg" alt="Pillow Peek" width={48} height={48} />
          </div>
