...
CREATE TABLE "product_variants" (
	...
	"firmness_id" varchar(20) NOT NULL,
...
ALTER TABLE "product_variants" ADD CONSTRAINT "product_variants_firmness_id_firmness_id_fk" FOREIGN KEY ("firmness_id") REFERENCES "public"."firmness"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "product_variants" ADD CONSTRAINT "product_variants_material_id_materials_id_fk" FOREIGN KEY ("material_id") REFERENCES "public"."materials"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
